...
include::{snippets}/add-like-travelogue/http-request.adoc[]

=== Response

include::{snippets}/add-like-travelogue/http-response.adoc[]

=== Response Fields

include::{snippets}/add-like-travelogue/response-fields.adoc[]
