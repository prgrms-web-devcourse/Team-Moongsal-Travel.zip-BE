...
=== Request
include::{snippets}/suggestion/http-request.adoc[]

=== Path Parameter
include::{snippets}/suggestion/query-parameters.adoc[]

=== Response
include::{snippets}/suggestion/http-response.adoc[]

=== Response
include::{snippets}/suggestion/response-body.adoc[]
