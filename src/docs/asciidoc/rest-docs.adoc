...
=== Request
include::{snippets}/email/find_password/http-request.adoc[]

=== RequestFields
include::{snippets}/email/find_password/request-fields.adoc[]

=== Response
include::{snippets}/email/find_password/http-response.adoc[]
...
=== Request
include::{snippets}/member/change_password/http-request.adoc[]

=== RequestFields
include::{snippets}/member/change_password/request-fields.adoc[]

=== Response
include::{snippets}/member/change_password/http-response.adoc[]
